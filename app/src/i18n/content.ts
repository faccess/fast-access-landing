...
const en = {
  ...
  whatis: {
    ...
    body: 'Fast Access is an end-to-end logistics partner running e-commerce operations in Saudi Arabia, from the first item entering the warehouse to the last order reaching your customer. One partner, one dashboard, full accountability.',
  ...
  hero: {
    ...
    statOnTime: 'Orders shipped on time', statInventory: 'Inventory accuracy', statCenters: 'Order picking accuracy',
  ...
  services: {
    ...
    items: [
      ...
      { title: 'Packing & Preparation', body: 'Products are packed in durable, damage-proof materials, finished with your brand identity on every order.' },
  ...
  pricing: {
    ...
    howTitle: 'Four factors set your price.',
...
const ar = {
  ...
  whatis: {
    ...
    body: 'فاست أكسس شريك لوجستي متكامل يدير عمليات المتاجر الإلكترونية في السعودية من أول قطعة تدخل المستودع حتى آخر طلب يوصل لعميلك. شريك واحد، لوحة واحدة، ومسؤولية كاملة.',
  ...
  pages: {
    ...
    pricing: { title: 'كيف نسعّر؟ ببساطة... على قدّ شغلك.', sub: 'ما عندنا باقات جاهزة تحشر تجارتك فيها. أدخل أرقامك بالحاسبة، وخذ عرض سعر مفصّل على وضعك الفعلي خلال يوم عمل واحد.' },
    ...
    mission: { title: 'رسالتنا', body: 'نمكّن أصحاب المتاجر من قيادة نموهم: يشغّلون بكفاءة، ويتوسّعون بجرأة، بدون ثقل التشغيل اللي يرافق النمو عادة.' },
    vision: { title: 'رؤيتنا', body: 'أن نكون الشريك التشغيلي الأول لنمو التجارة الإلكترونية في المنطقة، ببنية وأنظمة ذكية تنظم رحلة الطلب من لحظة الشراء إلى باب العميل.' },
    whoTitle: 'من نحن',
  ...
  hero: {
    ...
    statOnTime: 'الطلبات المشحونة ضمن الوقت المحدد', statInventory: 'دقة المخزون', statCenters: 'دقة تجهيز الطلبات',
  ...
  services: {
    ...
    items: [
      ...
      { title: 'التجهيز والتغليف', body: 'نحرص على تغليف المنتجات بمواد متينة غير قابلة للتلف ونضيف الأصالة عليها بعرض هوية علامتك التجارية.' },
  ...
  pricing: {
    ...
    howTitle: 'أربعة عوامل تحدد سعرك.',

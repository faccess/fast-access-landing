...
const en = {
  ...
  hero: {
    ...
    statOnTime: 'On-time dispatch', statPickPack: 'Avg. pick & pack', statCenters: 'Cloud warehouses', statCentersValue: 'Wide network',
...
const ar = {
  ...
  hero: {
    ...
    statOnTime: 'التزام بمواعيد الشحن', statPickPack: 'متوسط تجهيز الطلب', statCenters: 'مخازن سحابية', statCentersValue: 'شبكة واسعة',

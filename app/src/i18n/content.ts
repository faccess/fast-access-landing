...
const ar = {
  ...
  pages: {
    solutions: { title: 'حلولنا... كل اللي تحتاجه عشان توصل طلباتك', sub: 'من لحظة ما يوصلنا مخزونك إلى لحظة ما يبتسم عميلك، تخزين، تجهيز، شحن، ومتابعة لحظية، منظومة واحدة تشتغل عنك.' },

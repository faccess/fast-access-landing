...
export default function Coverage() {
  ...
  const stats = [
    { value: isAr ? 'السعودية' : 'KSA', label: isAr ? 'تغطية لجميع أنحاء المملكة' : 'Coverage across the whole Kingdom' },
            ...
            <div className="fa-netmap-frame">
              <svg
                ...
                <g fontFamily="inherit" fontSize="12" fontWeight="600" fill="rgba(244,244,241,0.62)">
                  ...
                  <text x="470" y="222" textAnchor="end">{isAr ? 'البحرين' : 'Bahrain'}</text>
                  <text x="486" y="196" textAnchor="middle">{isAr ? 'قطر' : 'Qatar'}</text>
                  <text x="610" y="236" textAnchor="start">{isAr ? 'الإمارات' : 'UAE'}</text>
